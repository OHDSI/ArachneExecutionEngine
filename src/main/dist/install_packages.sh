...
apt-get update && apt-get install -y --allow-unauthenticated libpq-dev build-essential gcc make libcurl4-openssl-dev libssl-dev curl libssh-dev libxml2-dev libdigest-hmac-perl libcairo2-dev wget unzip apt-transport-https python-dev krb5-user python3-dev python3-pip libgeos-dev libprotobuf-dev protobuf-compiler
