...
install_version("drat", version="0.1.4", type="source")
...
if ("highr" %in% installed.packages() == FALSE){
  install_version("highr", version="0.7", type="source")
}
...
if ("officer" %in% installed.packages() == FALSE){
  install_version("officer", version="0.3.2", type="source")
}
...
if ("ReporteRsjars" %in% installed.packages() == FALSE){
  install_version("ReporteRsjars", version="0.0.4", type="source")
}
